load ROICorrelation_Sub_002f
load whole_brain_HCP-MMP
sc=connectivity;
FC_emp=ROICorrelation;
...
%模拟时间长度
dt=0.1;
tmax=2000000; % WARNING: tmax should be larger than 50000  !
tspan=0:dt:tmax;
tzhouqi=100000;
G=5.1:0.1:5.5;
numWg=length(G);
...
for g = G
     ...
     for tr=1:nTrials
        ...
        for i=1:tzhouqi
            ...
            IE=we*iz*ones(N,1)+wplus*Jnmda*SE+g*Jnmda*sc*SE-JJJ*SI;
